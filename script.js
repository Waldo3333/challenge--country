...
for (let i = 0; i < monde.length; i++) {
  content += `
       <div class="${monde[i].region} ${monde[i].name}  country" id="country--${monde[i].name}">
        ...
        <p>Region: ${monde[i].region}</p>
        <p>Capital: ${monde[i].capital}</p>
      </div>`;
}

displayCountry.innerHTML = content;

//---------------------------------ETAPE-------------------------------------------------choix par region
...
regionButton.addEventListener("click", function () {
  if (regionSearch.style.display !== "block") {
    regionSearch.style.display = "block";
  } else if ((regionSearch.style.display = "block")) {
...
const filterShow = document.getElementsByClassName("filterShow");
const africa = document.getElementsByClassName("Africa");
const america = document.getElementsByClassName("Americas");
...
const polar = document.getElementsByClassName("Polar");
const antarctic = document.getElementsByClassName("Antarctic");
const pays = document.getElementsByClassName("country");

function showAfrica() {
  for (let i = 0; i < pays.length; i++) {
    if (!pays[i].classList.contains("Africa")) {
      console.log("oui");
...
function showAmerica() {
  for (let i = 0; i < pays.length; i++) {
    if (!pays[i].classList.contains("Americas")) {
      console.log("oui");
      pays[i].classList.add("filterHide");
      pays[i].classList.remove("filterShow");
    }
...
function showAsia() {
  for (let i = 0; i < pays.length; i++) {
    if (!pays[i].classList.contains("Asia")) {
      console.log("oui");
      pays[i].classList.add("filterHide");
      pays[i].classList.remove("filterShow");
    }
...
function showEurope() {
  for (let i = 0; i < pays.length; i++) {
    if (!pays[i].classList.contains("Europe")) {
      console.log("oui");
      pays[i].classList.add("filterHide");
      pays[i].classList.remove("filterShow");
    }
...
function showOceania() {
  for (let i = 0; i < pays.length; i++) {
    if (!pays[i].classList.contains("Oceania")) {
      console.log("oui");
      pays[i].classList.add("filterHide");
      pays[i].classList.remove("filterShow");
    }
...
//-------------------------------------ETAPE----------------------------------------------ouvrir un pays

const paysInfo = document.getElementById("country--dev");
let contentInfo = "";
let paysIndex = "";
const array = Array.from(pays);
...
array.forEach((element, index) => {
  element.addEventListener("click", () => {
    ...
    let languesNoms = [];
    let currency = monde[paysIndex].currencies;
    let currenciesNoms = [];

    for (let i = 0; i < langues.length; i++) {
      languesNoms.push(langues[i].name);
    }

    if (monde[paysIndex].currencies) {
      for (let i = 0; i < currency.length; i++) {
        currenciesNoms.push(currency[i].name);
      }
    }
    ...
    //----------------------------------------------------------- afficher la fiche du pays

    displayCountry.classList.add("filterHide");
    paysInfo.classList.add("filterShow");
    paysInfo.classList.remove("filterHide");
